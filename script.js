// --------------------------------------------
//  MẢNG 118 NGUYÊN TỐ — FULL & HOÀN CHỈNH
// --------------------------------------------
const elements = [
...
{number:13,symbol:"Al",name:"Aluminium",mass:"26.982",type:"Kim loại chuyển tiếp",group:13,period:3,x:13,y:3,color:"#FFD700"},
...
// Lanthanides (57–71)
{number:57,symbol:"La",name:"Lanthanum",mass:"138.91",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:58,symbol:"Ce",name:"Cerium",mass:"140.12",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:59,symbol:"Pr",name:"Praseodymium",mass:"140.91",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:60,symbol:"Nd",name:"Neodymium",mass:"144.24",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:61,symbol:"Pm",name:"Promethium",mass:"145",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:62,symbol:"Sm",name:"Samarium",mass:"150.36",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:63,symbol:"Eu",name:"Europium",mass:"151.96",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:64,symbol:"Gd",name:"Gadolinium",mass:"157.25",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:65,symbol:"Tb",name:"Terbium",mass:"158.93",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:66,symbol:"Dy",name:"Dysprosium",mass:"162.50",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:67,symbol:"Ho",name:"Holmium",mass:"164.93",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:68,symbol:"Er",name:"Erbium",mass:"167.26",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:69,symbol:"Tm",name:"Thulium",mass:"168.93",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:70,symbol:"Yb",name:"Ytterbium",mass:"173.05",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},
{number:71,symbol:"Lu",name:"Lutetium",mass:"174.97",type:"Kim loại",group:3,period:6,x:-1,y:-1,color:"#FFD700"},

// Regular row continues
...
// Actinides (89–103)
{number:89,symbol:"Ac",name:"Actinium",mass:"227",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:90,symbol:"Th",name:"Thorium",mass:"232.04",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:91,symbol:"Pa",name:"Protactinium",mass:"231.04",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:92,symbol:"U",name:"Uranium",mass:"238.03",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:93,symbol:"Np",name:"Neptunium",mass:"237",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:94,symbol:"Pu",name:"Plutonium",mass:"244",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:95,symbol:"Am",name:"Americium",mass:"243",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:96,symbol:"Cm",name:"Curium",mass:"247",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:97,symbol:"Bk",name:"Berkelium",mass:"247",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:98,symbol:"Cf",name:"Californium",mass:"251",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:99,symbol:"Es",name:"Einsteinium",mass:"252",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:100,symbol:"Fm",name:"Fermium",mass:"257",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:101,symbol:"Md",name:"Mendelevium",mass:"258",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:102,symbol:"No",name:"Nobelium",mass:"259",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},
{number:103,symbol:"Lr",name:"Lawrencium",mass:"262",type:"Kim loại",group:3,period:7,x:-1,y:-1,color:"#FFD700"},

// Continue regular row 7
...
function renderTables(list = elements){
  ...
  list.forEach(e=>{
    ...
    if(e.number >= 57 && e.number <= 71){
      box.style.gridColumn = e.number - 56;
      box.style.gridRow = 1;
      lanthActTable.appendChild(box);
    }
    // Actinides
    else if(e.number >= 89 && e.number <= 103){
      box.style.gridColumn = e.number - 88;
      box.style.gridRow = 2;
      lanthActTable.appendChild(box);
    }
    // Normal table
...
function drawAtom2D(Z){
  ...
  // Electron xoay
  const electrons = Math.min(Z, 28);
  for(let i=0;i<electrons;i++){
    const r = 45 + (i%4)*25;
    const angle = (Date.now()/900 + i) * 1.3;
